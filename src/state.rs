...
use crate::{camera::{Camera, self}, hittable::sphere::Sphere};
...
impl State {
    pub fn new(aspect_ratio: f64, width: u32, height: Option<i32>, 
        frames: u32, camera: Camera, entities_vec: Vec<Sphere>) -> Self {
       Self { aspect_ratio, width, height, frames, camera, entities_vec }
    }
